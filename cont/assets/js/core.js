...
const CONFIG_DEFAULT = {
  ctaCompras:'2.1.1.01', ctaVentas:'1.1.2.01', ctaIvaCompras:'1.1.5.01',
  ctaIvaVentas:'2.1.2.01', ctaIngreso:'4.1.1.05', iaEndpoint:'',
...
function saveConfigModal(){
  ...
  CONFIG = {
    ctaCompras:v('cfg-cta-compras-m')||CONFIG_DEFAULT.ctaCompras,
    ctaVentas:v('cfg-cta-ventas-m')||CONFIG_DEFAULT.ctaVentas,
    ctaIvaCompras:v('cfg-cta-iva-compras-m')||CONFIG_DEFAULT.ctaIvaCompras,
    ctaIvaVentas:v('cfg-cta-iva-ventas-m')||CONFIG_DEFAULT.ctaIvaVentas,
    ctaIngreso:v('cfg-cta-ingreso-m')||CONFIG_DEFAULT.ctaIngreso,
    ctaBanco:v('cfg-cta-banco-m')||CONFIG_DEFAULT.ctaBanco,
    ctaDepreciacion:v('cfg-cta-deprec-m')||CONFIG_DEFAULT.ctaDepreciacion,
    ctaDeprecAcum:v('cfg-cta-deprec-acum-m')||CONFIG_DEFAULT.ctaDeprecAcum,
    ctaGananciaActivo:v('cfg-cta-ganancia-activo-m')||CONFIG_DEFAULT.ctaGananciaActivo,
    ctaPerdidaActivo:v('cfg-cta-perdida-activo-m')||CONFIG_DEFAULT.ctaPerdidaActivo,
    iaEndpoint:v('cfg-ia-endpoint-m')||''
  };
  LS.set(K.config,CONFIG);
  /* Also sync pane-config selects */
  ['cfg-cta-compras','cfg-cta-ventas','cfg-cta-iva-compras','cfg-cta-iva-ventas','cfg-cta-ingreso',
   'cfg-cta-banco','cfg-cta-deprec','cfg-cta-deprec-acum','cfg-cta-ganancia-activo','cfg-cta-perdida-activo'].forEach(id=>{
    const ps=document.getElementById(id), ms=document.getElementById(id+'-m');
    if(ps&&ms) ps.value=ms.value;
  });
