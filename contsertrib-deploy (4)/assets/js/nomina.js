...
function mesesAntiguedad(f,per){
  ...
  /* Si el día del fin de mes es anterior al día de ingreso, restamos 1.
     Ej: ingreso 15-ene, fin feb-28 → 1 mes completo (feb no cumplió el día 15). */
  if(i.getDate()>1 && fin.getDate()<i.getDate()) ms--;
...
function calcularNomina(){
  ...
  const detalle=act.map(e=>{
    ...
    const meses=mesesAntiguedad(e.fecha,per);
